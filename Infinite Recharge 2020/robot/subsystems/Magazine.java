...
public class Magazine extends SubsystemBase {
  ...
  public void intakeMagazine(double magazinePosition){
    magazineMotor.set(ControlMode.MotionMagic, magazinePosition);
  }

  public void init() {
    magazineMotor.configFactoryDefault();

    magazineMotor.configSelectedFeedbackSensor(FeedbackDevice.IntegratedSensor, 0, TIMEOUT);
    magazineMotor.selectProfileSlot(0, 0); // slot #, PID #
    ...
    magazineMotor.configMotionAcceleration(40960, TIMEOUT); // 400 Optical Encoder accel and velocity targets
    ...
    magazineMotor.configAllowableClosedloopError(0, 5, TIMEOUT); // Error for 2048 CTRE Encoder

    magazineMotor.config_IntegralZone(0, 100, TIMEOUT); // I-zone limits

    magazineMotor.config_kP(0, .75, TIMEOUT);
    magazineMotor.config_kI(0, .001, TIMEOUT);
    magazineMotor.config_kD(0, 1., TIMEOUT);
    magazineMotor.config_kF(0, 0., TIMEOUT);
