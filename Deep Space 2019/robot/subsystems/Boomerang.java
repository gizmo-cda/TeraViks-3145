...
public class Boomerang extends Subsystem {
  ...
  public void initLiftMotor(){
    ...
    liftMotor.configPeakOutputForward(.3, TIMEOUT);
    liftMotor.configPeakOutputReverse(-.3, TIMEOUT);
  ...
  public void initLeftHatchMotor(){
    ...
    leftHatchMotor.configPeakOutputForward(.3, TIMEOUT);
    leftHatchMotor.configPeakOutputReverse(-.3, TIMEOUT);
  ...
  public void initRightHatchMotor(){
    ...
    rightHatchMotor.configPeakOutputForward(.3, TIMEOUT);
    rightHatchMotor.configPeakOutputReverse(-.3, TIMEOUT);
